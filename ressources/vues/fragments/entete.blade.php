...
$panier = \App\Modeles\Panier::trouverParIdSession($idSession);
...
<div class="conteneur">
    <div class="navTop__table">
        <a href="index.php">
<img class="menu__logo" src="liaisons/images/logo.svg" alt="" width="200">
        </a>
...
<div class="buttons">
{{--    <form method="post" action="index.php?controleur=compte&action=creation">--}}
<a href="index.php?controleur=compte&action=connexion" class="menu_btn compte"><span class="texteBtn">Mon compte</span> <svg width="30px" height="30px" color="orange" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" >
...
{{--    </form>--}}
{{--    <form method="post" action="index.php?controleur=compte&action=creation">--}}
<a class="menu_btn panier" href="index.php?controleur=panier&action=fiche&id={{$idPanier}}"><span class="texteBtn">Mon panier</span><svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<span class="menu__nbArticle {{$panier->getId()}}">{{$nbArticle}}</span>
</a>
{{--    </form>--}}
</div>
    </div>
