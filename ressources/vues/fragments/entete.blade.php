...
<a class="menu_btn compte"><span class="texteBtn">Mon compte</span> <svg width="30px" height="30px" color="orange" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" >
...
{{--    </form>--}}
{{--    <form method="post" action="index.php?controleur=compte&action=creation">--}}
<a class="menu_btn panier"><span class="texteBtn">Mon panier</span><svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
