@php
    use App\Modeles\Panier;$idSession = session_id();
...
<div class="conteneur">
    <div class="navTop__table">
        ...
        <div class="buttons">
            <a href="index.php?controleur=compte&action=connexion" class="menu_btn compte"><span class="texteBtn">Mon compte</span>
                <svg width="30px" height="30px" color="orange" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
		...
		s8,3.589,8,8c0,4.411-3.589,8-8,8S16,20.411,16,16z M24,28c6.977,0,12.856,5.107,14.525,12H9.475C11.144,33.107,17.023,28,24,28z"
            ...
            <!-- Inspiré du code fait par Erik Terwan
             Lien :https://codepen.io/erikterwan/pen/EVzeRP-->
            <a class="menu_btn panier" href="index.php?controleur=panier&action=fiche&id={{$idPanier}}"><span
                        class="texteBtn">Mon panier</span>
