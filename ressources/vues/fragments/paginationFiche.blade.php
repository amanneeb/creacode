...
@if ($numeroPage > 0)
    <a class="hyperlien" href="{{ $urlPagination . "&page=" . ($numeroPage - 1) ."#similaires"}}"><i class="fa-solid fa-circle-chevron-left fa-xl"></i></a>
@else
...
@if ($numeroPage+1 < $nombreTotalPages)
    <a class="hyperlien" href="{{ $urlPagination . "&page=" . ($numeroPage + 1)."#similaires"  }}"><i class="fa-solid fa-circle-chevron-right fa-xl"></i></a>
@else
