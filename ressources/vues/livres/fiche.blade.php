                    ...
                    <section class="ctnModale cache">
                        ...
                        <section class="ctnVisionneuse">
                            ...
                            <ul class="ctnVisionneuse__liste" >
                                <li class="ctnVisionneuse__item"><img class="ctnVisionneuse__img" src="./liaisons/images/livres/{{$lesLivres->getCategorie_id()}}/{{$lesLivres->getIsbn_papier()}}_w980.png" alt="couverture {{$lesLivres->getTitre()}}"></li>
                                @for($cpt = 1; $cpt<=3; $cpt++)
                                    <li class="ctnVisionneuse__item" id="{{$cpt}}">
                                        <img class="ctnVisionneuse__img " src="./liaisons/images/livres/extraits/{{$lesLivres->getIsbn_papier()}}_00{{$cpt}}_w980.png" alt="couverture {{$lesLivres->getTitre()}}">
                                    </li>
                                @endfor
                            </ul>
